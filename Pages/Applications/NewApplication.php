...
<body translate="no" onload="getChecked()">
    <ul class="breadcrumb">
        ...
        <li style="color: #585858;">Νέα Αίτηση</li>
    </ul>
        ...
        <div class="row justify-content-center">
            <div class="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                    ...
                    <form id="msform" action="../../includes/newApplication.inc.php" method="post">
                        <!-- progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset>
                            <div class="form-card">
                                <div class="row">
                                    ...
                                    <input name="name" id="name" type="text" onchange="getChecked()" value='<?php echo $_SESSION["name"]; ?>' />

                                    <label class="fieldlabels">Επίθετο: *</label>
                                    <input name="surname" id="surname" onchange="getChecked()" value='<?php echo $_SESSION["surname"]; ?>' />

                                    <label class="fieldlabels">Αριθμός Ταυτότητας: *</label>
                                    <input name="adt" id="adt" onchange="getChecked()" value='<?php session_start();
                                                                                                echo $_SESSION["adt"]; ?>' />

                                    <label class="fieldlabels">Α.Φ.Μ: *</label>
                                    <input name="afm" id="afm" onchange="getChecked()" type="text" value='<?php echo $_SESSION["afm"]; ?>'>

                                    <label class="fieldlabels">Email: *</label>
                                    <input type="email" id="email" onchange="getChecked()" name="email" value='<?php echo $_SESSION["email"]; ?>' />

                                    <label class="fieldlabels">Κινητό Τηλέφωνο: *</label>
                                    <input name="mobile" id="mobile" onchange="getChecked()" value='<?php echo $_SESSION["phone"]; ?>' />

                                    <label class="fieldlabels">Διεύθυνση: *</label>
                                    <input name="address" id="address" onchange="getChecked()" value='<?php echo $_SESSION["address"]; ?>' />
                                </div>

                            </div>
                            <button type="submit" onclick="save()" name="Save" class="sub-btn">Προσωρινή Αποθήκευση</button>
                        ...
                        <fieldset>
                            <div class="form-card">
                                <div class="row">
                                    ...
                                    <input name="country" id="country" onchange="getChecked()" type="text" placeholder="Xώρα Σπουδών">
                                    ...
                                    <input name="university" id="university" onchange="getChecked()" type="text" placeholder="Όνομα Πανεπιστημίου">

                                    <label class="fieldlabels">Τμήμα Πανεπιστημίου</label>
                                    <input name="department" id="department" onchange="getChecked()" type="text" placeholder="Τμήμα Πανεπιστημίου">

                                    <label class="fieldlabels">Τίτλος Σπουδών: *</label>
                                    <input name="title" id="title" onchange="getChecked()" placeholder="Τίτλος Σπουδών" />

                                    <label class="fieldlabels">Πιστωτικές Μονάδες (ECTS): *</label>
                                    <input type="text" onchange="getChecked()" name="ects" id="ects" placeholder="Πιστωτικές Μονάδες (ECTS)" />

                                    <label class="fieldlabels">Ημερομηνία Eγγραφής: *</label>
                                    <input type="date" onchange="getChecked()" name="regDate" id="regDate" placeholder="Ημερομηνία Eγγραφής" />

                                    <label class="fieldlabels">Ημερομηνία Aποφοίτησης: *</label>
                                    <input type="date" onchange="getChecked()" name="gradDate" id="gradDate" placeholder="Ημερομηνία Aποφοίτησης" />
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <label class="fieldlabels">Όνομα: *</label> <input type="text" name="name1" id="name1" />
                                <label class="fieldlabels">Επίθετο: *</label> <input name="surname1" placeholder="Επίθετο" id="surname1" />
                                <label class="fieldlabels">Αριθμός Ταυτότητας: *</label> <input name="adt1" placeholder="Αριθμός Ταυτότητας" id="adt1" />
                                <label class="fieldlabels">Α.Φ.Μ: *</label> <input name="afm1" placeholder="Α.Φ.Μ" id="afm1" />
                                <label class="fieldlabels">Email: *</label> <input type="email" name="email1" placeholder="Email" id="email1" />
                                <label class="fieldlabels">Κινητό Τηλέφωνο: *</label> <input name="mobile1" placeholder="Κινητό Τηλέφωνο" id="mobile1" />
                                <label class="fieldlabels">Διεύθυνση: *</label> <input name="address1" placeholder="Διεύθυνση" id="address1" />
                                <br>
                                <br>
                                ...
                                <label class="fieldlabels">Χώρα Σπουδών</label>
                                <input name="country1" id="country1" onchange="getChecked()" type="text" placeholder="Xώρα Σπουδών">
                                ...
                                <label class="fieldlabels">Όνομα Πανεπιστημίου</label>
                                <input name="university1" id="university1" onchange="getChecked()" type="text" placeholder="Όνομα Πανεπιστημίου">

                                <label class="fieldlabels">Τμήμα Πανεπιστημίου</label>
                                <input name="department1" id="department1" onchange="getChecked()" type="text" placeholder="Τμήμα Πανεπιστημίου">

                                <label class="fieldlabels">Τίτλος Σπουδών: *</label>
                                <input name="title1" id="title1" onchange="getChecked()" placeholder="Τίτλος Σπουδών" />

                                <label class="fieldlabels">Πιστωτικές Μονάδες (ECTS): *</label>
                                <input type="text" onchange="getChecked()" name="ects1" id="ects1" placeholder="Πιστωτικές Μονάδες (ECTS)" />

                                <label class="fieldlabels">Ημερομηνία Eγγραφής: *</label>
                                <input type="date" onchange="getChecked()" name="regDate1" id="regDate1" placeholder="Ημερομηνία Eγγραφής" />

                                <label class="fieldlabels">Ημερομηνία Aποφοίτησης: *</label>
                                <input type="date" onchange="getChecked()" name="gradDate1" id="gradDate1" placeholder="Ημερομηνία Aποφοίτησης" />
                        ...
                        <fieldset>
                            ...
                            <input type="submit" name="Submit" onclick="pay()" class="next action-button" value="Πληρωμή" />
                            <input type="button" name="previous" class="previous action-button-previous" value="Προηγούμενο" />
                        </fieldset>
                    </form>
                </div>
