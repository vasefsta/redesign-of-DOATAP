        ...
        <div class="wrapper ">
            ...
            <div class="main-panel">
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo">Όλες Οι Αιτήσεις</a>
                        </div>
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM application where status!='saved'";
                    ...
                    if ($result = mysqli_query($conn, $sql)) {
                        ...
                        while ($row = mysqli_fetch_row($result)) {
                            ...
                            if ($row[14] == NULL) {
                                ...
                                if ($row[14] == "accepted") {
                                    echo "<td>Εγκρίθηκε</td>";
                                    echo "<td>Οριστικοποιημένη</td>";
                                } else if ($row[14] == "rejected") {
                                    echo "<td>Απορρίφθηκε</td>";
                                    echo "<td>Οριστικοποιημένη</td>";
                                } else if ($row[14] == "submitted") {
                                    echo "<td>Υποβλημένη</td>";
                                    echo "<td><input type='checkbox' class='check-btn' name='checked[]' value=' " . $row[0] ." ' >";
                                    // echo "<td><a href='#'><img class='x-icon' src='https://cdn-icons-png.flaticon.com/512/1828/1828851.png' width='25px'/></a></td>";
                        ...
                        echo "</tbody>";
                        echo "</table>";
                        echo "<input type='submit' class='submit-btn' name='delete' value='Διαγραφή Επιλεγμένων' />";
                        echo "</form>";
                    }
                    ?>
