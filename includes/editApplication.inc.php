                            ...
                            <div class="form-card">
                                <div class="row">
                                    ...
                                    <select class="custom-select" name="type" id="type" onchange="getChecked()">
                                        ...
                                        <option label="Διδακτορικό"  <?php if($row2[2] == 'Διδακτορικό'){echo("selected");}?>>Διδακτορικό</option>
                                    </select>

                                    <label class="fieldlabels">Χώρα Σπουδών</label>
                                    <input name="country" id="country" onchange="getChecked()" type="text" placeholder="Xώρα Σπουδών" value='<?php echo "$row2[5]"?>'>
                                    ...
                                    <input name="university" id="university" onchange="getChecked()" type="text" placeholder="Όνομα Πανεπιστημίου" value='<?php echo "$row2[6]"?>'>

                                    <label class="fieldlabels">Τμήμα Πανεπιστημίου</label>
                                    <input name="department" id="department" onchange="getChecked()" type="text" placeholder="Τμήμα Πανεπιστημίου" value='<?php echo "$row2[4]"?>'>

                                    <label class="fieldlabels">Τίτλος Σπουδών: *</label>
                                    <input name="title" id="title" onchange="getChecked()" placeholder="Τίτλος Σπουδών" value='<?php echo "$row2[8]"?>' />

                                    <label class="fieldlabels">Πιστωτικές Μονάδες (ECTS): *</label>
                                    <input type="text" onchange="getChecked()" name="ects" id="ects" placeholder="Πιστωτικές Μονάδες (ECTS)" value='<?php echo "$row2[7]"?>' />

                                    <label class="fieldlabels">Ημερομηνία Eγγραφής: *</label>
                                    <input type="date" onchange="getChecked()" name="regDate" id="regDate" placeholder="Ημερομηνία Eγγραφής" value='<?php echo "$row2[9]"?>'/>

                                    <label class="fieldlabels">Ημερομηνία Aποφοίτησης: *</label>
                                    <input type="date" onchange="getChecked()" name="gradDate" id="gradDate" placeholder="Ημερομηνία Aποφοίτησης" value='<?php echo "$row2[10]"?>' />
